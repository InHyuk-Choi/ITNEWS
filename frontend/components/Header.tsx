          ...
          <div className="flex items-center justify-between h-16 gap-4">
            ...
            <div className="flex items-center gap-3 shrink-0">
              <button
                ...
                className="hidden sm:flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium rounded-lg bg-gradient-to-r from-yellow-400 to-orange-500 text-white hover:opacity-90 transition-opacity"
              >
                뉴스레터
              </button>
